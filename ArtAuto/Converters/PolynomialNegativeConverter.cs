...
{
    /// <summary>
    /// Класс вторичного преобразователя по полиномиальному закону с отрицательной степенью. y = a + b*x^-1 + c*x^-2 + ... + z*x^-n   
    /// </summary>
    public class PolynomialNegativeConverter : PolynomialConverter
    {

        public PolynomialNegativeConverter (string name, string description) : base (name, description)
        {
