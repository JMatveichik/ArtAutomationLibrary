...
{
    /// <summary>
    /// Класс вторичного преобразователя c выбором диапазона  
    /// </summary>
    public class MultiRangeConverter : BaseConverter
    {
        public MultiRangeConverter(string name, string description) : base (name, description)
        {
