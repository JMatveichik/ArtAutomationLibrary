...
{
    public class Adam6066 : Adam6000Base, IDiscreteInputDevice, IDiscreteOutputDevice
    {
     
        public Adam6066()
        {
            AdamModel = Adam6000Type.Adam6066;
        ...
        public Adam6066(string name, string description, int updateInterval) : base("ADAM-6066", name, description, updateInterval)
        {
            AdamModel = Adam6000Type.Adam6066;            
            DiscreteOutputs = new List<DiscreteOutput> () ;
            DiscreteInputs = new List<DiscreteInput>();
