...
{
    public class Adam6017 : Adam6000Base, IAnalogInputDevice, IDiscreteOutputDevice
    {
        public Adam6017()
        {
            AdamModel       = Adam6000Type.Adam6017;
        ...
        public Adam6017(string name, string description, int updateInterval) : base("ADAM-6017", name, description, updateInterval)
        {
            AdamModel       = Adam6000Type.Adam6017;
            AnalogInputs    = new List<AnalogInput>();
            DiscreteOutputs = new List<DiscreteOutput> () ;
